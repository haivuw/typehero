...
type WhoWins<A extends string, B extends string> = A extends B ? 'draw'
: Order extends `${B}${string}${A}` ? 'win'
: Order extends `${A}${string}${B}` ? 'lose'
: Order extends `${string}${B}${string}${A}${string}` ? 'lose'
: Order extends `${string}${A}${string}${B}${string}` ? 'win'
: never
